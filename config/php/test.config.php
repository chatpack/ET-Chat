...
$database = "et_chat";		//Datenbankname
$sqlhost  = "localhost";    	//Datenbank Hostname
$sqluser  = "webchat";         	//Datenbank Username
$sqlpass  = "webchat";    			//Datenbank Passwort
	
$prefix   = "et_chat_";			//Prefix bei den Tabellennamen und allen Sessionvariablen
