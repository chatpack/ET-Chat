...
// Bundled usage (browser + webpack)
if (window && !window.PeriodicalExecuter) {
...
// Bundled usage (browser + webpack)
if (window && !window.ObjectRange) {
  window.ObjectRange = ObjectRange;
}
