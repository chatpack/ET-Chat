...
function ET_Chat( config ) {
  ...
  this.messages_im_chat                 = config.messages_im_chat                 ? config.messages_im_chat                 : this.messages_im_chat;
  this.reload_interval                  = config.reload_interval                  ? config.reload_interval                  : this.reload_interval;
  this.username                         = config.username                         ? config.username                         : this.username;
  this.user_id                          = config.user_id                          ? config.user_id                          : this.user_id;
  this.userPrivilegienGlobal            = config.userPrivilegienGlobal            ? config.userPrivilegienGlobal            : this.userPrivilegienGlobal;
  this.win_style                        = config.win_style                        ? config.win_style                        : this.win_style;
  this.anbindung_an_userverwaltung      = config.anbindung_an_userverwaltung      ? config.anbindung_an_userverwaltung      : this.anbindung_an_userverwaltung;
  this.show_history_all_user            = config.show_history_all_user            ? config.show_history_all_user            : this.show_history_all_user;
  this.allowed_privates_in_chat_win     = config.allowed_privates_in_chat_win     ? config.allowed_privates_in_chat_win     : this.allowed_privates_in_chat_win;
  this.allowed_privates_in_separate_win = config.allowed_privates_in_separate_win ? config.allowed_privates_in_separate_win : this.allowed_privates_in_separate_win;
  this.interval_for_inactivity          = config.interval_for_inactivity          ? config.interval_for_inactivity          : this.interval_for_inactivity;
  this.set_dynamic_height               = config.set_dynamic_height               ? config.set_dynamic_height               : this.set_dynamic_height;
  this.allow_nick_registration          = config.allow_nick_registration          ? config.allow_nick_registration          : this.allow_nick_registration;
  this.textcolor                        = config.textcolor                        ? config.textcolor                        : this.textcolor;
  this.soundManager                     = config.soundManager                     ? config.soundManager                     : this.soundManager;
  this.sound_status                     = config.sound_status                     ? config.sound_status                     : this.sound_status;
  this.set_sys_messages                 = config.set_sys_messages                 ? config.set_sys_messages                 : this.set_sys_messages;
  this.random_user_number               = config.random_user_number               ? config.random_user_number               : this.random_user_number;
  ...
  if (jsonInhalt!=""){
    ...
    for (var i=0; i<jsonObj.data.length; i++){
         ...
         with ( jsonObj.data[i]){
            ...
            catch(e) { console.log( "chat.js::receiveResultJSON error: '" + e + "'" ); }
